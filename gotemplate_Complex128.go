...
func (o Complex128) MarshalJSON() (data []byte, err error) {
	if o.IsPresent() {
		return json.Marshal(o[valueKeyComplex128])
	}
	return nil, nil
}
...
func (c Complex128) Value() (driver.Value, error) {
	if c.IsPresent() {
		return json.Marshal(c[valueKeyComplex128])
	}
	return nil, nil
}

func (c *Complex128) Scan(input interface{}) (err error) {
	var val complex128
